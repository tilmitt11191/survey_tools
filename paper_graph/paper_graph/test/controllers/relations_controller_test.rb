...
class RelationsControllerTest < ActionController::TestCase
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post :create, relation: { dst_id: @relation.dst_id, src_id: @relation.src_id, strength: @relation.strength, type: @relation.type }
    end
  ...
  test "should update relation" do
    patch :update, id: @relation, relation: { dst_id: @relation.dst_id, src_id: @relation.src_id, strength: @relation.strength, type: @relation.type }
    assert_redirected_to relation_path(assigns(:relation))
  end
